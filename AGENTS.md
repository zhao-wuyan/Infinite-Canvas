...
This project is indexed by GitNexus as **Infinite-Canvas** (4492 symbols, 23633 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
