...
This project is indexed by GitNexus as **Infinite-Canvas** (7297 symbols, 23943 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
